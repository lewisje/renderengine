...
R.Engine.requires("R.physics.common.math.b2Math");
R.Engine.requires("R.physics.common.math.b2Vec2");
R.Engine.requires("R.physics.common.math.b2Mat22");

R.Engine.requires("R.physics.collision.b2AABB");
R.Engine.requires("R.physics.collision.b2Pair");

R.Engine.requires("R.physics.collision.shapes.b2Shape");

var b2CircleShape = R.physics.collision.shapes.b2Shape.extend({
   ...
   constructor: function(def, body, localCenter) {
      ...
      this.m_R = new R.physics.common.math.b2Mat22();
      this.m_position = new R.physics.common.math.b2Vec2();
      //
      ...
      this.m_proxyId = R.physics.collision.b2Pair.b2_nullProxy;
      ...
      // initialize instance variables for references
      this.m_localPosition = new R.physics.common.math.b2Vec2();
      //
      ...
      var aabb = new R.physics.collision.b2AABB();
      ...
      if (this.m_proxyId == R.physics.collision.b2Pair.b2_nullProxy)
      {
         this.m_body.Freeze();
      }
   },
   ...
   TestPoint: function(p){
      ...
      var d = new R.physics.common.math.b2Vec2();
      d.SetV(p);
      d.Subtract(this.m_position);
      return R.physics.common.math.b2Math.b2Dot(d, d) <= this.m_radius * this.m_radius;
   },

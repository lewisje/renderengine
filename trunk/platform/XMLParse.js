...
XMLDOC.Parser.node = function(parent, name, type)
{
   ...
   XMLDOC.Parser.node.prototype.node = function() {
      return this.nodes[this.cPtr];
   };
   ...
   XMLDOC.Parser.node.prototype.lastChild = function() {
      this.cPtr = this.nodes.length - 1;
      return this.node();
   };

   XMLDOC.Parser.node.prototype.nextChild = function() {
      this.cPtr++;
      if (this.cPtr == this.nodes.length)
      {
         this.cPtr = this.nodes.length - 1;
         return null;
      }
   ...
   XMLDOC.Parser.node.prototype.prevChild = function() {
      this.cPtr--;
      if (this.cPtr == -1)
      {
         this.cPtr = 0;
